...
export const EditMbr = () => {
    ...
    const{userName,email,mdp,fullName,typeUser,grade,tele,numeroBureau}=user
    ...
    const onSubmit=async(e)=>{
        e.preventDefault();
        await axios.put(`http://localhost:9090/updateUser/{id}?id=${id}`,user)
    ...
    return (
        <>
            ...
            <div className="container">
                <h1 className="text-center">Edite un Membre</h1>
